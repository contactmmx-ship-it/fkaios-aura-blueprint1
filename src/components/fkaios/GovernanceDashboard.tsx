...
export default function GovernanceDashboard() {
  ...
  // Founder Brain Brief moved to its own home screen (FounderBrainBrief.tsx)
  // — it used to be embedded here, duplicating "what should the founder see
  // first" across two screens and reading a table ("founder_memory") that
  // never existed. This screen now stays focused on governance depth:
  // constitution, decision ledger, executive intelligence detail, audit.
